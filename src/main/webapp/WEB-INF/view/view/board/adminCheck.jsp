		...
		<div id="faqBody">
			<div id="faqWrap">
				...
				<div class="conWrap p_center" id="selCSS2">
					...
					<div class="faq_box">
						<p class="faq_title" style="margin-top: 55px;">도서 등록 관리</p>
							...
							<div class="con">
								<div class="searchTop">
									<div class="search2">
										...
										<br>
										 <form name="FaqForm"
											action="${pageContext.request.contextPath}/admin/Check?page="
											method="post">
							...
							<section id="mainSection">
								...
								function deleteForm(booknum) {
									...
									if (result) {
										...
										// 삭제 pro로 이동 
										window.location.href = "${pageContext.request.contextPath}/admin/bookDeleteProcheck?booknum=" + booknum;
                              ...
                              <form action="checkBook" method="post">
                                 ...
                                 <input type="hidden" id="bookstate" name="bookstate" value="중고">
                                 <span class="btn_type blue"><a
                                  ><button type="submit">상품 등록</button></a></span></form>
                              </dd>
                              	<dd style="margin-bottom: 3px;">
								<span class="btn_type skyblue"><a
									href="javascript:void(0);"
									onclick="deleteForm(${b.booknum});">등록 거절</a></span>
								</dd>
								...
								<c:if test="${bookList.isEmpty()}">
									<div class="view_type" id="AREA_G_2">
										<br>
										<li>
											<div style="font-size: 15px; text-align: center;">등록 할 책
												정보가 없습니다.</div>
										</li>
									</div>
								</c:if>
