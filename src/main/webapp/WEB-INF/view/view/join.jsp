	...
	<div id="wrap">
		<form method="post" name="JoinForm" id="JoinForm">
			...
			<div class="jointype_tab_wrap">
				<ul>
					<li class="on"><a href="javascript:fn_navi_click(1);">일반
							개인 회원 (만 14세 이상)</a></li>
					<li><a href="javascript:fn_navi_click(3);">만 14세 미만 어린이 회원</a></li>
					<li><a href="javascript:fn_navi_click(4);">법인/단체
							(학교,기업,기관)</a></li>
					<li><a href="javascript:fn_navi_click(2);">Resident Abroad</a></li>
				</ul>
			</div>
					...
					<tr>
						...
						<td style="padding: 25px 0 0 0">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tbody>
									<tr>
										<td width="115" style="color: #333333; font-size: 12px">이름<span
											class="star">*</span></td>
																	...
																	<tbody>
																		...
																		<tr>
																			<td
																				...
																				style="padding: 6px 0 0 6px; margin: 0;">이름을
																					입력해주세요.</span>
																			</td>
																		</tr>
																		<tr>
									...
									<!--공통 : 이메일 -->
									<tr>
										<td style="color: #333333; font-size: 12px">이메일<span
											class="star">*</span></td>
										<td style="padding: 7px 0 7px 0;">
											<!--// 커서 OFF //-->
											<table width="100%" cellpadding="0" cellspacing="0"
												...
												<tbody>
													<tr>
														<td id="emailTd" width="345px"><input type="text"
															class="textjoin2" id="Email" name="Email"
															style="width: 74px; vertical-align: middle;"
															onfocus="javascript:InputFocusOn(this)"
															onblur="javascript:InputFocusOut(this)"
															onkeyup="javascript:InputDataCheck(this,'0');" value="">

															<span id="EamilSign">@</span> <input type="text"
															class="textjoin2" id="EmailDomainText"
															name="EmailDomainText"
															style="width: 92px; vertical-align: middle;"
															onfocus="javascript:InputFocusOn(this)"
															onblur="javascript:InputFocusOut(this)"
															onkeyup="javascript:InputDataCheck(this,'0');" value="">
														...
														</select> <input type="hidden" id="accountemail"
															name="accountemail" value=""></td>
														<td width="*">

															<div id="Email_helplayer"
																style="position: absolute; display: none; margin-top: -1px; z-index: 1;">
																<table width="100" border="0" cellspacing="0"
																	cellpadding="0">
																	<tbody>
																		...
																		<tr>
																			<td
																				...
																				<img
																				src="/ucl_editor/img_secur/account/makeAccount/20070910_bullet_03.jpg"
																				align="absmiddle"> <span id="Email_result"
																				style="padding: 6px 0 0 6px; margin: 0;">이메일
																					주소와 아이디로 로그인하실 수 있으며, 가입 후 메일 주소는 변경하실 수 있습니다.</span>
																			</td>
																		</tr>
																		<tr>
																			<td><img
										...
										<td style="padding: 7px 0 7px 0;">
											<table width="100%" cellpadding="0" cellspacing="0"
												...
												<tbody>
													<tr>
														<td width="210"><input type="password"
															name="PasswordVerify" id="PasswordVerify" maxlength="20"
															class="textjoin2"
															style="width: 200px; vertical-align: middle;"
															onfocus="javascript:InputFocusOn(this)"
															onblur="javascript:InputFocusOut(this)"
												...
												<tbody>
													<tr>
														<td width="217"><input type="text" name="hp1"
															...
															onfocus="javascript:InputFocusOn(this)"
															onblur="javascript:InputFocusOut(this)"
															onkeyup="javascript:InputDataCheck(this,'0');"></td>
														<td width="*">
									...
									<tr>
										<td></td>
										<td><strong>[중고매장 이용 고객님]</strong><br> 매장에서 인증하신
											휴대전화 번호를 입력하시면, 가입 후 매장 구매 내역이 자동으로 통합됩니다.</td>
									</tr>

									<tr style="display: none";"="">
										<td style="color: #333333; font-size: 12px">생년월일<span
											class="star">*</span></td>
										<td style="padding: 7px 0 7px 0;">
											<table width="100%" cellpadding="0" cellspacing="0"
												border="0">
												<tbody>
													<tr>
														<td width="217"><input type="text" id="BirthYear"
															maxlength="4" name="BirthYear" value="" class="textjoin2"
															style="width: 50px; vertical-align: middle;"
															onfocus="javascript:InputFocusOn(this)"
															onblur="javascript:InputFocusOut(this)"
															onkeyup="javascript:InputDataCheck(this,'0');"> 년

															<input type="text" id="BirthMonth" maxlength="2"
															name="BirthMonth" value="" class="textjoin2"
															style="width: 30px; vertical-align: middle;"
															onfocus="javascript:InputFocusOn(this)"
															onblur="javascript:InputFocusOut(this)"
															onkeyup="javascript:InputDataCheck(this,'0');"> 월

															<input type="text" id="BirthDay" maxlength="2"
															name="BirthDay" value="" class="textjoin2"
															style="width: 30px; vertical-align: middle;"
															onfocus="javascript:InputFocusOn(this)"
															onblur="javascript:InputFocusOut(this)"
															onkeyup="javascript:InputDataCheck(this,'0');"> 일

														</td>
														<td width="*">

															<div id="BirthYear_helplayer"
																style="position: absolute; display: none; margin-top: -1px; z-index: 1;">
																<table width="100" border="0" cellspacing="0"
																	cellpadding="0">
																	<tbody>
																		...
																		<tr>
																			<td
																				...
																				<img
																				src="/ucl_editor/img_secur/account/makeAccount/20070910_bullet_03.jpg"
																				align="absmiddle"> <span id="BirthYear_result"
																				style="padding: 6px 0 0 6px; margin: 0;">생년을
																					입력해주세요</span>
																			</td>
																		</tr>
																		<tr>
																	...
																	<tbody>
																		...
																		<tr>
																			<td
																				...
																				src="/ucl_editor/img_secur/account/makeAccount/20070910_bullet_03.jpg"
																				align="absmiddle"> <span
																				id="BirthMonth_result"
																				style="padding: 6px 0 0 6px; margin: 0;">생월을
																					입력해주세요</span>
																			</td>
																		</tr>
																		<tr>
																	...
																	<tbody>
																		...
																		<tr>
																			<td
																				...
																				<img
																				src="/ucl_editor/img_secur/account/makeAccount/20070910_bullet_03.jpg"
																				align="absmiddle"> <span id="BirthDay_result"
																				style="padding: 6px 0 0 6px; margin: 0;">생일을
																					입력해주세요</span>
																			</td>
																		</tr>
																		<tr>
															...
															style="color: #787878; font-size: 12px; padding: 0 0 0 0px;">&nbsp;</span>
														</td>
													</tr>
												</tbody>
											</table>
									...
									<tr style="display: none;">
										<td style="color: #333333; font-size: 12px">성별</td>
										<td style="padding: 7px 0 7px 0;">
											<table width="100%" cellpadding="0" cellspacing="0"
												border="0">
												<tbody>
													<tr>
														<td width="217"><input type="radio" name="Sex"
															id="Sex1" value="1" class="input_radio"><label
															for="Sex1" class="linkP">남</label><input type="radio"
															name="Sex" id="Sex2" value="2" class="input_radio"
															style="margin-left: 14px;"><label for="Sex2"
															class="linkP">여</label></td>
													</tr>
												</tbody>
											</table>
										</td>
...
-->
						...
						<td style="padding: 25px 0 0 0">
							<div class="join_agrCheckAll">
								<input type="checkbox" name="agrStipulationAll"
									id="agrStipulationAll" value="1"
									onclick="fn_stipulation_checkall()"> <label
			...
			<div
				style="margin: 0 auto; padding: 20px 0; text-align: center; width: 930px">
				<img id="process-img"
