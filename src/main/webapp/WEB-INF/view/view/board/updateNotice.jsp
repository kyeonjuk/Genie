			...
			<div id="counselWrap">
				...
				<div class="conWrap p_center" id="selCSS2">
					<div class="counsel_box">
						<p class="counsel_title">공지사항 수정</p>
						<p class="counsel_mtitle">관리자 전용 - 공지사항 수정</p>
					</div>
					...
					<div id="conBig" style="width: 100%;">
						...
						<div class="boardRegisterDiv">
							<form name="notice"
								action="${pageContext.request.contextPath}/board/notice/updatePro?noticeId=${notice.getNoticeId()}"
								method="post">
								...
								<table id="1" class="boardList07" width="100%" border="0"
									...
									<tbody>
										...
										<tr>
											<th>제목</th>
											<td class="td_L10 tdE"><input type="text" name="title" value="${notice.getTitle()}"
									...
									<tbody>
										...
										<tr>
											...
											<td class="td_L10 tdE"><textarea
													style="min-width: 600px; height: 240px;" name="content" >${notice.getContent()}</textarea>
											</td>
										</tr>
									</tbody>
								</table>
