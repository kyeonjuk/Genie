			...
			<div id="counselWrap">
				...
				<div class="conWrap p_center" id="selCSS2">
					<div class="counsel_box">
						<p class="counsel_title">FAQ 등록</p>
						<p class="counsel_mtitle">관리자 전용 - FAQ 등록</p>
					</div>
					...
					<div id="conBig" style="width: 100%;">
						...
						<div class="boardRegisterDiv">
							<form name="faq"
								action="${pageContext.request.contextPath}/board/faq/writePro"
								method="post">
												...
												<p id="cateIdSelectArea1" class="fl_left mr5">
													<select id="category" name="category"
														style="border: 1pt solid #999999; font-size: 9pt; color: #333333;"><option
															value="">분류 선택</option>
														<option value="order">주문/주문변경</option>
														<option value="pay">결제</option>
														<option value="delivery">배송</option>
														<option value="returns">반품/교환</option>
								...
								<table id="1" class="boardList07" width="100%" border="0"
									...
									<tbody>
										...
										<tr>
											<th>FAQ 질문</th>
											<td class="td_L10 tdE"><input type="text" name="question"
								...
								<table id="1" class="boardList07" width="100%" border="0"
									...
									<tbody>
										...
										<tr>
											<th>FAQ 답변</th>
											<td class="td_L10 tdE"><textarea rows="20" cols="100" name="answer"
												style="min-width: 350px;" maxlength="1000"></textarea>
												<p id="commentLength" class="al_right t_11gr"
													style="display: none"></p></td>
										</tr>
									</tbody>
