				...
				<div class="conWrap p_center" id="selCSS2">
					...
					<div id="conBig" style="width: 100%;">
						...
						<div class="boardRegisterDiv">
							<form name="event"
								action="${pageContext.request.contextPath}/board/event/updatePro?eventId=${event.getEventId()}"
									...
									<tbody>
										...
										<tr>
											...
											<td class="td_L10 tdE"><input type="text" name="title"
												value="${event.getTitle()}" style="min-width: 350px;"
												maxlength="100">
								...
								<table id="5" class="boardList07" width="100%" border="0"
									...
									<tbody>
										...
										<tr>
											<th>배너 이미지</th>
											<td class="td_L10 tdE">새로운 파일로 변경 : <input type="file"
												name="file1" style="border: none; height: 25px;"></td>
										</tr>
									</tbody>
								</table>
								...
								<table id="5" class="boardList07" width="100%" border="0"
									...
									<tbody>
										...
										<tr>
											<th>내용</th>
											<td class="td_L10 tdE">새로운 파일로 변경 : <input type="file"
												name="file2" style="border: none; height: 25px;"></td>
										</tr>
									</tbody>
								</table>
									...
									<tbody>
										...
										<tr>
											...
											<td class="td_L10 tdE"><input type="hidden"
												...
												value="${event.getStartDate() }"> <input
												type="hidden" name="enddate" id="enddate"
												value="${event.getEndDate()}"> <!-- 날짜 선택 --> <span
												class="block mt5"> <span id="year"><select
