		...
		<div class="login-wrapper">
			<div style="text-align: center;">
				<a href="<%=request.getContextPath()%>/main.jsp"> <img
					src="${pageContext.request.contextPath}/image/logo/findpw.png"
			...
			<form method="post" action="findIdPro" id="login-form">
				...
				아이디<input type="text" name="userid" id="userid"> 이메일<input
					type="email" name="email" id="email"> <input type="submit"
					id="findPass" value="비밀번호 찾기">

				<div>
					<a href="${pageContext.request.contextPath}/member/join" class="">회원가입
						하기</a> <span>&nbsp;|&nbsp;</span> <a href="${pageContext.request.contextPath}/member/findIdForm" class="">아이디 찾기</a>
				</div>
			</form>
		</div>
	</div>
