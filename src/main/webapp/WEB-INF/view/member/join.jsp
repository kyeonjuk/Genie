...
function checkAgree(){
	var agree = document.getElementById("agrAladin1"); // 체크박스를 불러온다
	var agree = document.getElementById("agrCommunity1");
	var agree = document.getElementById("agrInfo1");
	//input 태그의 checkbox인 경우 체크가 되어 있으면 true가 나온다.
	//체크가 안되어 있으면 false가 나온다.
...
<body>
	...
	<div id="wrap">
		<form method="post" action="joinPro" name="join" id="join">
						...
						<td style="padding: 25px 0 0 0">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tbody>
												...
												<tbody>
													...
													<tr>
														<td width="210"><input type="text" class="textjoin2"
															...
															onfocus="javascript:InputFocusOn(this)"
															onblur="javascript:InputFocusOut(this)"
															onkeyup="javascript:InputDataCheck(this,'0');" value="" required="required">
														</td>
														<td width="*">
															...
															<div id="CustId_helplayer"
																...
																<table width="100" border="0" cellspacing="0"
 																...
 																<span style="color: #787878; font-size: 12px; padding: 0 0 0 14px;">
																	<button type="button" onclick="useridChk()">중복체크</button>
									...
									<!--공통 : 비밀번호(재확인) -->
									<tr>
										<td style="color: #333333; font-size: 12px">성별<span
											class="star">*</span></td>
										<td style="padding: 7px 0 7px 0;">
											<table width="100%" cellpadding="0" cellspacing="0"
												border="0">
												<tbody>
													<tr>
														...
														남성<input type="radio"
															...
															class="textjoin2"
															required="required" value="남성">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															여성<input type="radio"
															name="gender" id="gender"
															class="textjoin2"
															required="required" value="여성">
															</div>
														</td>
														<td width="*">
																	...
																	<tbody>
																		...
																		<tr>
																			<td
																				...
																				style="padding: 6px 0 0 6px; margin: 0;">성별을 체크해주세요.</span>
																			</td>
																		</tr>
																		<tr>
																			<td><img
									...
									<!--공통 : 연락처-->
									<tr>
										<td style="color: #333333; font-size: 12px">연락처<span
											class="star">*</span></td>
										<td style="padding: 7px 0 7px 0;">
											<!--휴대전화-->
											<table width="100%" cellpadding="0" cellspacing="0"
												...
												<tbody>
													<tr>
														<td width="217"><input type="text" name="tel"
															value="" id="tel" class="textjoin2" maxlength="20"
															style="width: 200px; vertical-align: middle;"
															onfocus="javascript:InputFocusOn(this)"
															onblur="javascript:InputFocusOut(this)"
															onkeyup="javascript:InputDataCheck(this,'0');" required="required">
														</td>
														<td width="*">
									...
									<tr>
										...
										<td style="padding: 7px 0 7px 0;"> 
											...
											<table width="100%" cellpadding="0" cellspacing="0"
												border="0">
												<tbody>
														<td id="emailTd" width="217"><input type="email"
												...
												<tbody>
													<tr>
														...
														<td><input type="date" id="birthday"
															maxlength="8" name="birthday" value="" class="textjoin2"
																	...
																	<tbody>
																		...
																		<tr>
																			<td
																				...
																				src="/ucl_editor/img_secur/account/makeAccount/20070910_bullet_03.jpg"
																				align="absmiddle"> <span id="CustId_result"
																				style="padding: 6px 0 0 6px; margin: 0;">생년월일을	 입력해 주세요</span>
																			</td>
																		</tr>
...
.liststyle_2 li {
	...
	*margin-left: 0px;
	...
	list-style-type: upper-roman;
						...
						<td style="padding: 25px 0 0 0">
							...
							<ul class="join_agrCheck_new">
								<li><input type="checkbox" id="agrAladin1" name="agrAladin"
									class="agree" value="1" required="required"> <label for="agrAladin1">[필수]
								...
								<li><input type="checkbox" id="agrCommunity1"
									name="agrCommunity" class="agree" value="1" required="required"> <label
								...
								<li><input type="checkbox" id="agrInfo1" name="agrInfo"
									class="agree" value="1" required="required"> <label for="agrInfo1">[필수]
			...
			<div
				style="margin: 0 auto; padding: 30px 0 0 0; width: 930px"></div>
			...
			<div style="margin: 0 auto; padding: 20px 0; text-align: center; width: 930px">
				...
				<!-- <a href="javascript:void(0);" onclick="frmsubmit(); return false;">회원가입하기</a> -->
				
				<!-- <a href="login" onclick="return checkAgree();"> -->
				<button  style="color: #fff;padding: 12px 29px;">가입하기</button><!-- </a> -->
