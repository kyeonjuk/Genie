...
<c:set var="c" value="${checkreview}" /> 


	<c:if test="${c eq userid && userid ne null}">
	<c:forEach var="l" items="${loadreview }">
					  ...
					  <form action="ReviewUpdate" method="post">
						...
						<div class="hundred_box">
							<div class="Hleft1">
								<div class="starbox">
								<c:if test="${l.point eq 5 }">
									<div class="star-rating">
										<input type="radio" id="5-stars" name="point" value="5" checked="checked"/> <label
										...
										<c:if test="${l.point eq 4 }">
									<div class="star-rating">
										<input type="radio" id="5-stars" name="point" value="5" /> <label
											for="5-stars" class="star">&#9733;</label> <input
											type="radio" id="4-stars" name="point" value="4" checked="checked" /> <label
											for="4-stars" class="star">&#9733;</label> <input
											type="radio" id="3-stars" name="point" value="3" /> <label
											for="3-stars" class="star">&#9733;</label> <input
											type="radio" id="2-stars" name="point" value="2" /> <label
									...
									<c:if test="${l.point eq 3 }">
									<div class="star-rating">
										<input type="radio" id="5-stars" name="point" value="5" /> <label
											for="5-stars" class="star">&#9733;</label> <input
											type="radio" id="4-stars" name="point" value="4" /> <label
											for="4-stars" class="star">&#9733;</label> <input
											type="radio" id="3-stars" name="point" value="3" checked="checked"/> <label
											for="3-stars" class="star">&#9733;</label> <input
											type="radio" id="2-stars" name="point" value="2" /> <label
											for="2-stars" class="star">&#9733;</label> <input
											type="radio" id="1-star" name="point" value="1" /> <label
									...
									<div class="star-rating">
										<input type="radio" id="5-stars" name="point" value="5" /> <label
											...
											type="radio" id="3-stars" name="point" value="3" /> <label
											for="3-stars" class="star">&#9733;</label> <input
											type="radio" id="2-stars" name="point" value="2" checked="checked" /> <label
											for="2-stars" class="star">&#9733;</label> <input
											type="radio" id="1-star" name="point" value="1" /> <label
											for="1-star" class="star">&#9733;</label> <input type="radio"
											id="0-star" name="point" value="0" /> <label for="0-star"
									...
									<div class="star-rating">
										<input type="radio" id="5-stars" name="point" value="5" /> <label
											...
											type="radio" id="2-stars" name="point" value="2" /> <label
											for="2-stars" class="star">&#9733;</label> <input
											type="radio" id="1-star" name="point" value="1" checked="checked"/> <label
											for="1-star" class="star">&#9733;</label> <input type="radio"
											id="0-star" name="point" value="0" /> <label for="0-star"
											class="star"></label>
									</div>
								</c:if>
										<c:if test="${l.point eq 0 }">
									<div class="star-rating">
										<input type="radio" id="5-stars" name="point" value="5" /> <label
											for="5-stars" class="star">&#9733;</label> <input
											type="radio" id="4-stars" name="point" value="4" /> <label
							...
							<div class="hundred_box">
								<div class="Hleft1">
									<div class="">
										<textarea id="review" name="review" cols="87" rows="3"
											...
											style="resize: none; width: 95%;">${l.review }</textarea>
								...
								<div class="Hright1">
									<div class="Ere_btn_register">
										...
										<button type="submit" id="reviewbtn">수정</button>
									</div>
								</div>
							</div>
					...
					<form action="ReviewDelete" method="post">
															 	<div class="Ere_btn_blog_sym2">
																	...
																	<input type="hidden" name="reviewid" id=reviewid value="${l.reviewid}"> 
	...
	<c:if test="${c ne userid || userid eq null}">
